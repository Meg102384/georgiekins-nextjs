...
export default function Nav() {
  ...
  return (
    <nav className="bg-cream/90 backdrop-blur-md border-b-2 border-dashed border-line-pink">
      <div className="max-w-[1100px] mx-auto flex items-center justify-between gap-4 px-5 py-1">
        <Link
          href="/"
